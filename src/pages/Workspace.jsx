...
export default function Workspace() {
  ...
  return (
    <>
      {team && (
        <div className="w-screen  h-screen pt-20 overflow-x-hidden overflow-y-hidden font-sans pb-20 ">
          <img
            src={team.img}
            alt="cover"
          ...
          <section className="w-full h-full overflow-y-auto p-b-20 border-2">
            {/* <DragAndDrop2 /> */}
            <DragAndDrop/>
          </section>
        </div>
